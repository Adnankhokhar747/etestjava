...
@Entity
@Table(name = "debitB2C_line_item")
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, property = "id")
public class DebitB2CLineItem {
    @Id
    ...
    @JoinColumn(name = "CreditInvoice")
    private DebitInvoiceB2C invoice;
    ...
    public DebitInvoiceB2C getInvoiceId() {
        return invoice;
    }

    public void setInvoiceId(DebitInvoiceB2C invoiceId) {
