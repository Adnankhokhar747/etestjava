...
@Entity
@Table(name = "creditB2C_line_item")
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, property = "id")
public class CreditB2CLineItem {
        @Id
        ...
        @JoinColumn(name = "CreditInvoiceB2C")
        private CreditInvoiceB2C invoice;
        ...
        public CreditInvoiceB2C getInvoiceId() {
            return invoice;
        }

        public void setInvoiceId(CreditInvoiceB2C invoiceId) {
