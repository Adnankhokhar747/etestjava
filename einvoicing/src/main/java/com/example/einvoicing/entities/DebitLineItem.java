...
public class DebitLineItem {
    ...
    @JoinColumn(name = "debitInvoice")
    private DebitInvoice invoice;
    ...
    public DebitInvoice getInvoiceId() {
        return invoice;
    }

    public void setInvoiceId(DebitInvoice invoiceId) {
